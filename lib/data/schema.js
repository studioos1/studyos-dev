...
export const ED={profile:EP,schools:[],terms:[],courses:[],assignments:[],exams:[],adhoc:[],gymLogs:[],dailyLogs:[],pomodoroLogs:[],history:[],briefCache:null,briefPeriod:null,quarterPlan:null,studyPlan:{weeks:{}},completionLog:[],onboarded:false,planStale:false};
