...
import { repairTermLinkageIfNeeded, migrateLegacyTermIfNeeded, datesOverlap, canDeleteTerm, computeTermStatuses, migrateTermStatusIfNeeded, syncActiveTermToProfilePatch, backfillTermsInitializedIfNeeded, applyTermScopedPatch, migrateTermDataIsolationIfNeeded, termScopedForPlanning, termAsProfile, projectTermForPlanning } from "./terms";
...
describe("termScopedForPlanning with an explicit term", () => {
  const data = {
    ...
    terms: [{ id: "tA", status: "current" }, { id: "tB", status: "upcoming" }],
  };
...
describe("projectTermForPlanning", () => {
  ...
  const currentTerm = { id: "tA", schoolId: "s1", status: "current", name: "Fall 2026", start: "2026-09-24", end: "2026-12-15", studyPlan: { weeks: { wA: 1 } }, quarterPlan: { x: "a" } };
  const upcomingTerm = { id: "tB", schoolId: "s1", status: "upcoming", name: "Winter 2027", start: "2027-01-04", end: "2027-03-15", studyPlan: { weeks: { wB: 2 } }, quarterPlan: null };
  const data = {
