...
export const APP_VERSION="2.81.10";
export const APP_BUILD_DATE="2026-09-20";
export const APP_BUILD_TIME="Browser permission row simplified: plain label/description with a centered On/Off marker, no more highlighted bar";
