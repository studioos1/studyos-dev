...
export const APP_VERSION="2.82.2";
export const APP_BUILD_DATE="2026-09-20";
export const APP_BUILD_TIME="Browser Notifications gets a real Turn off/Turn on master switch, matching SMS Reminders exactly";
