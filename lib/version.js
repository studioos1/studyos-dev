...
export const APP_VERSION="2.81.9";
export const APP_BUILD_DATE="2026-09-20";
export const APP_BUILD_TIME="\"Due-date reminders\" renamed to Browser Notifications and aligned with the rest of the Notifications tab";
