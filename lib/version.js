...
export const APP_VERSION="2.81.2";
export const APP_BUILD_DATE="2026-09-19";
export const APP_BUILD_TIME="Bell log now also populated server-side once a day, so it's accurate next time the app opens even if the computer was asleep or closed when something became urgent";
