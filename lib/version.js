...
export const APP_VERSION="2.81.3";
export const APP_BUILD_DATE="2026-09-19";
export const APP_BUILD_TIME="Scheduled reminders now fire via GitHub Actions instead of Vercel Cron Jobs, which turned out to be silently unavailable on the Hobby plan";
