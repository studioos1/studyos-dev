...
export const APP_VERSION="2.81.7";
export const APP_BUILD_DATE="2026-09-19";
export const APP_BUILD_TIME="Notifications tab's Phone number and Custom reminders fields now use the same centered/aligned layout as every other Preferences tab";
