...
export const APP_VERSION="2.80.6";
export const APP_BUILD_DATE="2026-09-19";
export const APP_BUILD_TIME="Preferences: field/select widths now match Meal times exactly (were stretching to their own max-width); removed the duplicate Evening check-in icon from the global header";
