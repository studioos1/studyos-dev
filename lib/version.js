...
export const APP_BUILD_TIME="Project deadlines now get their own countdown, same as exams, in the daily summary SMS and the bell log/browser notification";
