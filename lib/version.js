...
export const APP_VERSION="2.79.2";
export const APP_BUILD_DATE="2026-09-18";
export const APP_BUILD_TIME="SMS: 10-digit validation, auto-verify-and-confirm on a new number, sized buttons, white error text";
