...
export const APP_VERSION="2.79.4";
export const APP_BUILD_DATE="2026-09-18";
export const APP_BUILD_TIME="Preferences UI consistency pass: sized buttons/toggle/input, fixed tinted-text-on-tinted-bg banners";
