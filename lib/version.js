...
export const APP_VERSION="2.80.2";
export const APP_BUILD_DATE="2026-09-18";
export const APP_BUILD_TIME="Daily Schedule fields: Sleep & Wake, Study preferences and Meal times now share one centered, aligned field column across all 3 cards — verified against a real mobile viewport, no overflow";
