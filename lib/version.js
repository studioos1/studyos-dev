...
export const APP_VERSION="2.83.2";
export const APP_BUILD_DATE="2026-09-21";
export const APP_BUILD_TIME="Help drawer: dropped the strikethrough on completed checklist items — the green check is the one done signal now";
