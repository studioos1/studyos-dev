...
export const APP_BUILD_TIME="Preferences UI consistency + mobile pass: compact time/date/number fields everywhere, Study preferences on one row, gym schedule now start+duration, and 11 tinted-bg readability fixes app-wide";
